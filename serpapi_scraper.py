...
"""
Taken from:
https://serpapi.com/blog/scrape-all-google-scholar-profile-author-results-with-python-and-serpapi/#author_article_results

This script will scrape all the articles from a Google Scholar profile for the list of of authors in the excel sheet
"""
